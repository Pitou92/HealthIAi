    ...
    <SafeAreaView className="flex-1 bg-background px-6">
      ...
      <View className="flex-1 justify-center gap-8 -mt-20">
        <View className="gap-2">
          <Text variant="muted">Bon retour 👋</Text>
        ...
        <Card className="gap-4">
          ...
          <Button className="mt-2" disabled={loading} onPress={handleLogin}>
            {loading ? <ActivityIndicator color="#FFF" /> : <Text className="text-primary-foreground font-semibold text-base">Se connecter</Text>}
          </Button>
